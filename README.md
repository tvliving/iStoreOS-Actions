...
> [!TIP]
> <span style="color: #90EE90">😂此固件为非官方构建，不保证完全无BUG，请知悉😂</span>
> 
> <span style="color: #90EE90">😂如果您对当前项目有抵触心理，欢迎您使用右侧项目😂👉👉👉[iStoreOS-Native](https://github.com/Kwonelee/iStoreOS-Native)</span>
> 
> <span style="color: #90EE90">使用此仓库必须设置机密token，Actions云构建固件时需要用到，通常在仓库设置里面。机密键名为 `GH_TOKEN`（严禁在仓库可视代码中填写，否则后果自负）</span>
